...
- Part_4: Linear Regression
- Part_5: Logistic Regression + Dense Layer
- Part_6: MultiLayer Perceptron
- Part_7: New Optimizators
- NN1: Part_6 functionality in .py format
- NN2: Part7 functionality in .py format
